...
const HomeClient = () => {
    const [accessFileURL, setAccessFileURL] =
        useState<string>("/api/files/access_full");
        ...
        <div className="max-w-6xl mx-auto p-6 min-h-screen">
            ...
            <div className="mt-8">
                <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center gap-4"> {/* Use flex to align items */}
                        <p className="font-medium">Output</p>
                        {filterTime !== null && ( // Only display if filterTime is not null
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Filter time: {filterTime.toFixed(2)} ms {/* Display with 2 decimal places */}
                            </p>
                        )}
                    </div>
