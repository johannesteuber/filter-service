...
type AccessRightsProps = {
  ...
  fineGranularDefinition: string;
  accessFileFinegrainedObjectsURL: string;
  setAccessFileFinegrainedObjectURL: (value: string) => void;
  accessFileFinegrainedRightsURL: string;
  setAccessFileFinegrainedRightsURL: (value: string) => void;
...
export const AccessRightsSelection = ({
  ...
  setAccessFileFinegrainedRightsURL,
