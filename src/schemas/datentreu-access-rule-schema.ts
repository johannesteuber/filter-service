...
export const DatentreuAccessRightsSchema = z.object({
  objectId: z.string(),
  objectEntityClass: z.string(),
  identityId: z.string(),
  objectProperties: z.object({
    readProperties: z.array(z.string()).optional(),
    ...
    digitsAccess: z.array(
      z.object({
        ...
        type: z.enum(["readProperties", "writeProperties", "shareReadProperties", "shareWriteProperties"]),
      }),
    ).optional(),
...
export const DatentreuAccessFileSchema = z.array(DatentreuAccessRightsSchema);
